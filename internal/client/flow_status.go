...
func logFlowStatus(logger *slog.Logger, s FlowLogStatus) {
	logger.Info("flow log runtime", "storage_failures_total", s.StorageFailures, "corrupt_spools_total", s.CorruptSpools, "restored_windows_total", s.RestoredWindows, "enabled", s.Enabled, "active_windows", s.ActiveWindows, "pending_windows", s.PendingWindows,
