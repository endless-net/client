...
type Config struct {
	...
	NodeCredentialSigningTrust *clientapi.SigningTrustBundle   `json:"node_credential_signing_trust_bundle,omitempty"`
	...
	ResourcePreferencesRetired map[string]bool                 `json:"resource_preferences_retired,omitempty"`
