...
func sensitiveDiagnosticsKey(key string) bool {
	...
	switch normalized {
	case "token", "enroll_token", "enrollment_token", "join_token", "access_token", "refresh_token", "session_token", "authorization", "bearer", "poll_authorization", "pollauthorization", "renewal_authorization", "renewalauthorization", "renewal_grant", "renewalgrant", "user_session", "usersession":
		return true
	}
