...
| BR-13 | AC-13 | Authorized exit selection, LAN and fail-closed behavior; IT-30 | Exit handlers, durable executor machinery and Linux engine components exist; production adapter/worker and complete OS/LAN effects remain. Signed policy uses pinned clientapi; unresolved Q-07 variants remain external |
