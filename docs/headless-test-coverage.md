...
| HC-050 | C signed cross-network machine grant with exact TCP scope, expiry, renewal and withdrawal passed all 24 repetitions at `92983ae`; U two-engine direct/Relay direction and key-rotation tests | Later live-rights replacement extension still needs qualification; new recipient identity and real source-Client variants |
