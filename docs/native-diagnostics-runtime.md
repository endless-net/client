...
The retired Logout handler/DTO and unused recovery-helper result DTO are removed.
Native host coverage now includes confirmed node/session logout, registration
