...
| US-10 | `service_rpc_preferences.go`, `service_rpc_uiquit.go` | `service_rpc_preferences_test.go`, `service_rpc_uiquit_test.go` | Inbound/DNS/routes and lifecycle keys, policy intersection/provenance/locks, atomic patches and actual effects |
